...
福岡県嘉穂地域（飯塚市・嘉麻市・桂川町）の情報を発信するポータルサイトです。

## 概要

このプロジェクトは、旧嘉飯山地区（飯塚市・嘉麻市・桂川町）の魅力を伝え、住民や観光客に役立つ情報を提供する地域ポータルサイトです。プレーンなHTML、CSS、JavaScriptを使用して構築されており、依存関係が最小限に抑えられています。

行政情報やFAQなど自治体ごとに異なるコンテンツは**タブ切替UI**で整理し、観光・イベント・グルメなど地域共通のコンテンツは**エリアバッジ＋フィルター機能**で3市町の情報を横断的に閲覧できます。
